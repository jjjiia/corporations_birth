...
locator = geopy.geocoders.GoogleV3(api_key = "AIzaSyBK0NFEiJvyYINdriuet8fObfWIEDwjNbM")
...
def geocoder():
	...
	with open(activeFile, 'a+') as newcsvfile:
		...
		#spamwriter.writerow(["company","status","reason","zip","birth","death","jurisdiction", "jurisdictionType","lat","lng"])
		...
		with open('/Users/Jia/Documents/map_birth_death/data/CorporationsData_Original.csv', 'rb') as csvfile:
			...
			for row in spamreader:
				...
				birth = row[8]
				address = row[9]
				if address !="" and birth !="" and death!="" and jurisdiction!="":
